											...
											<div class="tabbable">
												...
												<div class="tab-content profile-edit-tab-content">
													<div id="edit-basic" class="tab-pane in active">
														<form enctype="multipart/form-data" action="<?php echo base_url("user/c_dashboard/profile_edit");?>" method="POST"/>
													...
													<div id="edit-settings" class="tab-pane">
														...
														<form action="<?php echo base_url("user/c_dashboard/additional_edit");?>" method="POST">
														<div class="control-group">
													...
													<div id="edit-password" class="tab-pane">
														<div class="space-10"></div>
														<form action="<?php echo base_url("user/c_dashboard/bank_edit");?>" method="POST">
														<div class="control-group">
													...
													<div id="testimoni" class="tab-pane">
														<div class="space-10"></div>
														<form action="<?php echo base_url("user/c_dashboard/testimoni_edit");?>" method="POST">
														<div class="control-group">
