			...
			<div class="tabbable">
				...
				<div class="tab-content profile-edit-tab-content">
					<div id="edit-basic" class="tab-pane in active">
						<form enctype="multipart/form-data" action="<?php echo base_url("administrator/c_home/tambahBanner");?>" method="POST">
						<div class="control-group">
							<label class="control-label" for="form-field-1">CAPTION :</label>

							<div class="controls">
								<input type="text" id="form-field-1" name="judul_banner" class="input-xxlarge"  />
							</div>
						</div>
						<div class="control-group">
